const calcUTDelay = require('../index');
...
describe('#index.js', () => {
  describe('#Logic', () => {
    ...
    it('If the param greater than 6000, it should throw an error.', () => {
      expect(() => {calcUTDelay(6001)}).to.throw();
    });
  });
  ...
  describe('#Verification', () => {
    ...
    it('Input 333, output 7074.[天文算法 9.b]', () => {
      expect(calcUTDelay(1100).toFixed(1)).equal('7074');
    });
  })
});